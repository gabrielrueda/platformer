...
# Music
pygame.mixer.init()
pygame.mixer.music.load(os.getcwd() + '/Assets/sounds/gamemusic3.mp3')


#Font Variables
font = pygame.font.Font(os.path.dirname(os.getcwd()) + '/platformer/Assets/font2.TTF', 16)
fontBIG = pygame.font.Font(os.path.dirname(os.getcwd()) + '/platformer/Assets/font2.TTF', 36)
...
lvlOutline = [
    ...
    pygame.transform.scale(pygame.image.load(os.path.dirname(os.getcwd()) + '/platformer/Assets/level2Larger.png'),(WIDTH,HEIGHT)), 
     pygame.transform.scale(pygame.image.load(os.path.dirname(os.getcwd()) + '/platformer/Assets/level3Larger.png'),(WIDTH,HEIGHT)), 
      pygame.transform.scale(pygame.image.load(os.path.dirname(os.getcwd()) + '/platformer/Assets/level4Larger.png'),(WIDTH,HEIGHT)), 
       pygame.transform.scale(pygame.image.load(os.path.dirname(os.getcwd()) + '/platformer/Assets/level5Larger.png'),(WIDTH,HEIGHT)), 
]
